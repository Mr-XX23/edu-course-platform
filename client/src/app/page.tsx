          ...
          <nav className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/auth/login">
                <Button variant="ghost" className="text-white hover:text-[#714af5]">
                  Sign In
                </Button>
              </Link>
              <Link href="/auth/register">
                <Button className="bg-[#714af5] hover:bg-[#5a3bd4] text-white">Get Started</Button>
              </Link>
            </div>
          </nav>
        </header>
        ...
        <main className="container mx-auto px-4 py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join thousands of learners advancing their careers with our comprehensive online courses. Learn at your
              own pace with industry experts.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/auth/register">
                <Button size="lg" className="bg-[#714af5] hover:bg-[#5a3bd4] text-white px-8 py-4 text-lg group">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            ...
            <Card className="bg-gray-800/50 backdrop-blur-lg border-gray-700/50">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-400">Flexible scheduling that fits your lifestyle and learning preferences</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-800/50 backdrop-blur-lg border-gray-700/50">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Certified Learning</h3>
                <p className="text-gray-400">Earn certificates upon completion to showcase your new skills</p>
              </CardContent>
            </Card>
          </div>
        </main>
